        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly access_level: {
                    ...
                    readonly description: "The access level of your API key<br><br>`trial`, `production`";
                };
                readonly language_code: {
                    readonly type: "string";
                    readonly enum: readonly ["en", "en_us"];
                    readonly default: "en";
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "2-letter code for supported languages<br><br>`en` (English), `en_us` (English - supports diacritical marks)<br><br>English (`en` or `en_us`) is the only fully supported language for this API. Click <span style=\"text-decoration:underline\">[here](https://api-docs.sportradar.us/misc/Sportradar_API_Languages.xlsx)</span> for valid language codes and a tabular list of available languages per competition.";
                };
                readonly format: {
                    readonly type: "string";
                    ...
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "Format returned<br><br>`json`, `xml`";
                };
            };
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly competition_id: {
                    ...
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "Unique Id of a competition, found in the <span style=\"text-decoration:underline\">[Competitions](https://developer.sportradar.com/mma/reference/mma-competitions-list)</span> endpoint.<br><br>**Example:** `sr:competition:25457`";
                };
                readonly format: {
                    readonly type: "string";
                    readonly enum: readonly ["json", "xml"];
            ...
            readonly properties: {
                ...
                readonly competition: {
                    ...
                    readonly properties: {
                        ...
                        readonly name: {
                            readonly type: "string";
                            readonly examples: readonly ["UFC Contender Series, Las Vegas, Week 26"];
                        };
                        readonly parent_id: {
                            readonly type: "string";
                ...
                readonly seasons: {
                    ...
                    readonly items: {
                        ...
                        readonly properties: {
                            ...
                            readonly name: {
                                readonly type: "string";
                                readonly examples: readonly ["Dana White's Contender Series: Season 5, Week 6 2021"];
                            };
                            readonly start_date: {
                                readonly type: "string";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly competitor_id: {
                    ...
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "Unique Id of a competitor<br><br>**Example:** `sr:competitor:237652`";
                };
                readonly format: {
                    readonly type: "string";
                    readonly enum: readonly ["json", "xml"];
            ...
            readonly required: readonly ["access_level", "language_code", "competitor_id", "format"];
        }];
    };
    readonly response: {
        readonly "200": {
                                        ...
                                        readonly properties: {
                                            ...
                                            readonly stage: {
                                                ...
                                                readonly properties: {
                                                    readonly phase: {
                                                        readonly type: "string";
                                                        readonly examples: readonly ["1st_part_of_season_1st_leg"];
                                                    };
                                                    readonly type: {
                                                        readonly type: "string";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly competitor_id2: {
                    ...
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "Unique Id of a competitor<br><br>**Example:** `sr:competitor:237640`";
                };
                readonly format: {
                    readonly type: "string";
                    readonly enum: readonly ["json", "xml"];
            ...
            readonly required: readonly ["access_level", "language_code", "competitor_id", "competitor_id2", "format"];
        }];
    };
    readonly response: {
        readonly "200": {
...
declare const MmaDailySummaries: {
    readonly metadata: {
        readonly allOf: readonly [{
            ...
            readonly required: readonly ["access_level", "language_code", "date", "format"];
        }, {
            readonly type: "object";
            readonly properties: {
                readonly start: {
                    ...
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "The number of items to skip before starting to collect the result set.<br>Default: `0`<br><br>Example: `start=200` to receive a 2nd page of results (if necessary)<br><br><i>Note: You may alternatively use `offset`</i>";
                };
                readonly limit: {
                    readonly type: "integer";
                    readonly format: "int32";
                    ...
                    readonly maximum: 2147483647;
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "The number of items to return.<br>Maximum: `200`<br>Default value: `200`<br><br>Example: `limit=5`<br><br>**Note**: Pagination may be required to pull all data within this feed. By default, the feed will return 200 sport events.";
                };
            };
    ...
    readonly metadata: {
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly season_id: {
                    readonly type: "string";
                    readonly default: "sr:season:123885";
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "Unique Id of an event/season, found in the <span style=\"text-decoration:underline\">[Seasons](https://developer.sportradar.com/mma/reference/mma-seasons)</span> endpoint<br><br>**Example:** `sr:season:123885`";
                };
                readonly format: {
                    readonly type: "string";
                    readonly enum: readonly ["json", "xml"];
            ...
            readonly required: readonly ["access_level", "language_code", "season_id", "format"];
        }, {
            readonly type: "object";
            readonly properties: {
                readonly start: {
                    ...
                    readonly maximum: 2147483647;
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "The number of items to skip before starting to collect the result set.<br>Default: `0`<br><br>Example: `start=1000` to receive a 2nd page of results (if necessary)<br><br><i>Note: You may alternatively use `offset`</i>";
                };
                readonly limit: {
                    readonly type: "integer";
                    readonly format: "int32";
                    ...
                    readonly maximum: 2147483647;
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "The number of items to return.<br>Maximum: `1000`<br>Default value: `1000`<br><br>Example: `limit=5`";
                };
            };
            readonly required: readonly [];
        }];
            ...
            readonly properties: {
                ...
                readonly season: {
                    ...
                    readonly properties: {
                        ...
                        readonly name: {
                            readonly type: "string";
                            readonly examples: readonly ["UFC Fight Night - Ladd vs. Dumont 2021"];
                        };
                        readonly start_date: {
                            readonly type: "string";
                        ...
                        readonly competition: {
                            ...
                            readonly properties: {
                                ...
                                readonly name: {
                                    readonly type: "string";
                                    readonly examples: readonly ["UFC Fight Night - Ladd vs. Dumont"];
                                };
                            };
                        };
                    };
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly start: {
                    ...
                    readonly maximum: 2147483647;
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "The number of items to skip before starting to collect the result set.<br>Default: `0`<br><br><i>Note: You may alternatively use `offset`</i>";
                };
                readonly limit: {
                    readonly type: "integer";
                    readonly format: "int32";
                ...
                readonly seasons: {
                    ...
                    readonly items: {
                        ...
                        readonly properties: {
                            ...
                            readonly name: {
                                readonly type: "string";
                                readonly examples: readonly ["UFC Contender Series, Las Vegas, Week 26 2018"];
                            };
                            readonly start_date: {
                                readonly type: "string";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly limit: {
                    ...
                    readonly maximum: 2147483647;
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "The number of items to return.<br>Maximum: `200`<br>Default value: `200`<br><br>Example: `limit=5`<br><br>**Note**: Pagination will often be required to pull all data within this feed. By default, the feed will return 200 sport events.";
                };
            };
            readonly required: readonly [];
        }];
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly sport_event_id: {
                    readonly type: "string";
                    readonly default: "sr:sport_event:53563565";
                    readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
                    readonly description: "Unique Id of an event/fight<br><br>**Example:** `sr:sport_event:53563565`";
                };
                readonly format: {
                    readonly type: "string";
                    readonly enum: readonly ["json", "xml"];
...
export { MmaChampions, MmaCompetitionInfo, MmaCompetitionsList, MmaCompetitionsSeasons, MmaCompetitorMergeMappings, MmaCompetitorProfile, MmaCompetitorSummaries, MmaCompetitorVsCompetitor, MmaDailySummaries, MmaLiveSummaries, MmaRankings, MmaSeasonCompetitors, MmaSeasonInformation, MmaSeasonProbabilities, MmaSeasonSummaries, MmaSeasons, MmaSportEventChangeLog, MmaSportEventSummary, MmaSportEventsCreated, MmaSportEventsRemoved };
