...
// Use require for CommonJS modules (APICore)
const APICoreModule = require('api/dist/core');
const APICore = APICoreModule.default || APICoreModule;

const definition = JSON.parse(readFileSync(join(__dirname, 'openapi.json'), 'utf8'));

// Handle both default export and named export for Oas
const Oas = OasPackage.default || OasPackage;

class SDK {
    constructor() {
        // Try different initialization methods for Oas
        this.spec = typeof Oas.init === 'function' 
            ? Oas.init(definition)
            : typeof Oas === 'function'
                ? new Oas(definition)
                : Oas;
        
        // Now APICore should work as it's properly loaded via require
        this.core = new APICore(this.spec, 'sportradar-mma/unknown (api/6.1.3)');
    }
    /**
    ...
    mmaChampions(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/champions.{format}', 'get', metadata);
    }
    /**
    ...
    mmaCompetitionInfo(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/competitions/{competition_id}/info.{format}', 'get', metadata);
    }
    /**
    ...
    mmaCompetitionsList(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/competitions.{format}', 'get', metadata);
    }
    /**
    ...
    mmaCompetitionsSeasons(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/competitions/{competition_id}/seasons.{format}', 'get', metadata);
    }
    /**
    ...
    mmaCompetitorMergeMappings(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/competitors/merge_mappings.{format}', 'get', metadata);
    }
    /**
    ...
    mmaCompetitorProfile(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/competitors/{competitor_id}/profile.{format}', 'get', metadata);
    }
    /**
    ...
    mmaDailySummaries(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/schedules/{date}/summaries.{format}', 'get', metadata);
    }
    /**
    ...
    mmaLiveSummaries(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/schedules/live/summaries.{format}', 'get', metadata);
    }
    /**
    ...
    mmaCompetitorSummaries(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/competitors/{competitor_id}/summaries.{format}', 'get', metadata);
    }
    /**
    ...
    mmaCompetitorVsCompetitor(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/competitors/{competitor_id}/versus/{competitor_id2}/summaries.{format}', 'get', metadata);
    }
    /**
    ...
    mmaRankings(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/rankings.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSeasonProbabilities(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/seasons/{season_id}/probabilities.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSeasonSummaries(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/seasons/{season_id}/summaries.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSeasonInformation(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/seasons/{season_id}/info.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSeasonCompetitors(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/seasons/{season_id}/competitors.{format}', 'get', metadata);
    }
    /**
     ...
     */
    mmaSeasons(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/seasons.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSportEventSummary(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/sport_events/{sport_event_id}/summary.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSportEventsRemoved(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/sport_events/removed.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSportEventChangeLog(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/sport_events/updated.{format}', 'get', metadata);
    }
    /**
    ...
    mmaSportEventsCreated(metadata) {
        return this.core.fetch('/{access_level}/v2/{language_code}/sport_events/created.{format}', 'get', metadata);
    }
}
